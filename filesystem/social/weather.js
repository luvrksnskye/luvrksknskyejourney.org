const fetchWeather = (latitude, longitude) => {
  ...
  fetch(url)
    ...
    .then(data => {
      ...
      const weatherMap = {
        0: '../../assets/skye/clear.png',
        1: '../../assets/skye/clear.png',
        2: '../../assets/skye/cloud.png',
        3: '../../assets/skye/cloud.png',
        45: '../../assets/skye/mist.png',
        48: '../../assets/skye/mist.png',
        51: '../../assets/skye/rain.png',
        53: '../../assets/skye/rain.png',
        55: '../../assets/skye/rain.png',
        56: '../../assets/skye/rain.png',
        57: '../../assets/skye/rain.png',
        61: '../../assets/skye/rain.png',
        63: '../../assets/skye/rain.png',
        65: '../../assets/skye/rain.png',
        66: '../../assets/skye/rain.png',
        67: '../../assets/skye/rain.png',
        71: '../../assets/skye/snow.png',
        73: '../../assets/skye/snow.png',
        75: '../../assets/skye/snow.png',
        77: '../../assets/skye/snow.png',
        80: '../../assets/skye/rain.png',
        81: '../../assets/skye/rain.png',
        82: '../../assets/skye/rain.png',
        85: '../../assets/skye/snow.png',
        86: '../../assets/skye/snow.png',
        95: '../../assets/skye/rain.png',
        96: '../../assets/skye/rain.png',
        99: '../../assets/skye/rain.png',
      };
