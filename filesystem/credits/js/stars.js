...
const sounds = {  
  starTouch: new Audio('/assets/audio/sfx/star-touch.mp3'),  
  luma: new Audio('/assets/audio/sfx/luma.mp3'),  
  dogbark: new Audio('/assets/audio/sfx/undertale-dog-bark.mp3'),
  catsound: new Audio('/assets/audio/sfx/undertale-hot-cat-sound-effect.mp3')
};  
...
function createInfoPanel(star) {
  ...
  img.src = '/assets/images/achievements/new-star.png';
