document.addEventListener('DOMContentLoaded', function() {
  ...
  if (!hasSeenNotification) {
    ...
    setTimeout(function() {
      ...
      const appearSound = new Audio('/assets/audio/sfx/woah.mp3');
      appearSound.play();
  ...
  function handleOkieButton() {
    const soundEffect = new Audio('/assets/audio/sfx/mystical-chime.mp3');
    soundEffect.play();
  ...
  if (notificationopenBtn) {
    notificationopenBtn.addEventListener('click', function() {
      const gearSound = new Audio('/assets/audio/sfx/gear.mp3');
      gearSound.play();
