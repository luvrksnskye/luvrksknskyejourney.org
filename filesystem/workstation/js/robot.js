  ...
  dreamy: [
    {
      ...
      artist: "TUNIC OST",
      src: "assets/audio/music/from-far-shores.mp3"
    },
    {
      title: "The Throes of Winter",
      artist: "GHOST DATA",
      src: "assets/audio/music/the-throes-of-winter.mp3"
    }
  ],
  melancholic: [
    {
      ...
      src: "assets/audio/music/a-home-for-flowers-tulip.mp3"
    },
    {
      title: "Trees...",
      artist: "OMOCAT (OMORI OST)",
      src: "assets/audio/music/trees.mp3"
    },
    {
      title: "Sugar Star Planetarium",
      artist: "OMOCAT (OMORI OST)",
      src: "assets/audio/music/sugar-star-planetarium-slowed.mp3"
    },
    {
      title: "A Home For Flowers (Daisy)",
      artist: "OMOCAT (OMORI OST)",
      src: "assets/audio/music/a-home-for-flowers-daisy.mp3"
    }
  ],
  energetic: [
    {
      ...
      artist: "HOYO-MiX",
      src: "assets/audio/music/zenless-zone-zero.mp3"
    },
    {
      title: "Space Walk",
      artist: "HOYO-MiX",
      src: "assets/audio/music/space-walk.mp3"
    },
    {
      title: "The Game Is On",
      artist: "HOYO-MiX",
      src: "assets/audio/music/the-game-is-on.mp3"
    },
    {
      title: "fReeStyLE",
      artist: "HOYO-MiX",
      src: "assets/audio/music/freestyle.mp3"
    },
    {
      title: "Call of the Stars",
      artist: "HOYO-MiX",
      src: "assets/audio/music/call-of-the-stars.mp3"
    },
    {
      title: "Derailed Order",
      artist: "HOYO-MiX",
      src: "assets/audio/music/derailed-order.mp3"
    },
    {
      title: "Sword of Corruption",
      artist: "HOYO-MiX",
      src: "assets/audio/music/sword-of-corruption.mp3"
    },
    {
      title: "Champion of Embers",
      artist: "HOYO-MiX",
      src: "assets/audio/music/champion-of-embers.mp3"
    },
    {
      title: "无尽的施工日·白昼",
      artist: "Sān-Z · HOYO-MiX",
      src: "assets/audio/music/idklol.mp3"
    },
    {
      title: "Way Up",
      artist: "Jaden Smith",
      src: "assets/audio/music/way-up.mp3"
    },
    {
      title: "What's Up Danger",
      artist: "Blackway & Black Caviar",
      src: "assets/audio/music/whats-up-danger.mp3"
    }
  ],
  default: [
    {
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function initializeApp() {
    ...
    appState.activatedSfx = new Audio("assets/audio/sfx/activated.ogg");
    appState.talkingSfx = new Audio("assets/audio/sfx/robot-talking.ogg");
  ...
  function startInteraction() {
    ...
    appState.dialogTimeout = setTimeout(() => {
      let greeting = "Hi! Welcome to update 2.4 of Skye Journey. My name is B-12. I'm your musical assistant. Remember: You can play with the terminal or navigate using the icons on the left. Whichever is easier for you. Now let's find the perfect soundtrack for this moment!";
  ...
  function startDeepConversation() {
    ...
    if (appState.userPreferences.recentConversations.length >= 5) {
      appState.userPreferences.recentConversations.shift();
    }
  ...
  function showInteractionDialog(text, callback) {
    ...
    appState.interactionDialogButtons.innerHTML = '';
