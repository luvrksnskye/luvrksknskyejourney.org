        ...
        const sounds = {
            pien: new Audio("/assets/audio/sfx/pien.mp3") ,
            gear: new Audio("/assets/audio/sfx/gear.mp3"),
            select: new Audio("assets/audio/sfx/select.mp3"),
            selection: new Audio("/assets/audio/sfx/selection.mp3")
        };
...
> FUN STUFF:
  ...
  • Coffee dependency: Critical`;
            ...
            uptime: () => {
                sounds.gear.play();
                const uptimeHours = Math.floor(Math.random() * 168) + 24;
  ...
  Online presence:
     ...
     • Email: luvrksnskyedev@icloud.com
