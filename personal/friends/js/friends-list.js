...
✦ Likes to draw`,
        inventory: [
            {
                img: "assets/images/friends-items/taiyaki.png",
                name: "taiyaki"
            },
            {
                img: "assets/images/friends-items/potato-fries-sundae.png",
                name: "french fries... with ice cream?"
            },
            {
                img: "assets/images/friends-items/dream-syrup.png",
                name: "dream syrup"
            },
            {
                img: "assets/images/friends-items/rainbow-macarons.png",
                name: "macarons!!"
            },
            {
                img: "assets/images/friends-items/iconcoffe-1.png",
                name: "coffe"
            }
        ],
        website: "",
        websiteUrl:"https://luvrksnskye.github.io/Regredanger-Website/",
        constellation: "assets/images/constellation/regre.png"
    },
    {
        name: "Luciferaza",
...
✦ Genderfluid`,
        inventory: [
            {
                img: "assets/images/friends-items/hundredlayer-sundae-zero-calories.png",
                name: "huge ice cream lol"
            },
            {
                img: "assets/images/friends-items/sweet-dream.png",
                name: "sweet dream... Xiao's specialty!"
            },
            {
                img: "assets/images/friends-items/tuna-sushi.png",
                name: "a full stack of poisoned sushi for some reason"
            },
            {
                img: "assets/images/friends-items/onigiri.png",
                name: "onigiri"
            },
            {
                img: "assets/images/friends-items/tea-break-pancake.png",
                name: "very cute breakfast"
            }
        ],
        website: "",
        websiteUrl: "https://linktr.ee/luciferaza",
        constellation: "assets/images/constellation/luciferaza.png"
    },
    {
        name: "Noiz",
...
✦ He loves cake!!`,
        inventory: [
            {
                img: "assets/images/friends-items/pour-la-justice.png",
                name: "cake"
            },
            {
                img: "assets/images/friends-items/rainbow-aster.png",
                name: "rainbow aster"
            },
            {
                img: "assets/images/friends-items/padisarah-pudding.png",
                name: "pudding!"
            },
            {
                img: "assets/images/friends-items/sweet-shrimp-sushi.png",
                name: "some sushi he took from his girlfriend"
            },
            {
                img: "assets/images/friends-items/la-lettre-a-focalors.png",
                name: "more cake"
            },
            {
                img: "assets/images/friends-items/golden-chicken-burger.png",
                name: "golden chicken burger"
            }
        ],
        website: "Check out Noiz social media!",
        websiteUrl: "https://linktr.ee/NoisyDragon",
        constellation: "assets/images/constellation/noiz.png"
    },
    {
        name: "Narr",
...
✦ Local seal with internet access who likes to annoy their friends`,
        inventory: [
            {
                img: "assets/images/friends-items/energizing-bento.png",
                name: "cute bento box"
            },
            {
                img: "assets/images/friends-items/invigorating-kitty-meal.png",
                name: "kitty meal!"
            },
            {
                img: "assets/images/friends-items/lightless-eye-of-the-maelstrom.png",
                name: "there is a black hole in their pocket"
            },
            {
                img: "assets/images/friends-items/trash.png",
                name: "trash???"
            },
            {
                img: "assets/images/friends-items/pleasantlooking-trash.png",
                name: "pleasant looking trash lol"
            }
        ],
        website: "Check out their carrd!!",
        websiteUrl: "https://mochynarr.carrd.co/",
        constellation: "assets/images/constellation/narr.png" 
    },
    {
...
✦ Enjoys video games of all types`,
        inventory: [
            {
                img: "assets/images/friends-items/rose-bush.png",
                name:  "a cute and big rose bush!"
            },
            {
                img: "assets/images/friends-items/unknown.png",
                name:  "Unknown"
            },
            {
                img: "assets/images/friends-items/unknown.png",
        ...
        constellation: "assets/images/constellation/pearlia.png" 
    },
    {
        name: "Lilithdev",
...
✦ Negative social skills`,
        inventory: [
            {
                img: "assets/images/friends-items/scissors.png",
                name:  "scissors"
            },
            {
                img: "assets/images/friends-items/pien.png",
                name:  "pien"
            },
            {
                img: "assets/images/friends-items/phone.png",
                name:  "a cracked phone"
            },
            {
                img: "assets/images/friends-items/stairs.png",
                name:  "waxed weathered cut copper stairs"
            },
            {
                img: "assets/images/friends-items/amethyst.png",
                name: "amethyst"
            }
        ],
        website: "Go check out the Lilithdev website!",
        websiteUrl: "https://lilithdev.neocities.org/",
        constellation: "assets/images/constellation/lilith.png" 
    },
    {
        name: "Chissuuu",
        ...
        inventory: [
            {
                img: "assets/images/friends-items/comfort-food.png",
                name:  "noddles!"
            },
            {
                img: "assets/images/friends-items/iconcoffe-21.png",
                name:  "some ice coffe"
            },
            {
                img: "assets/images/friends-items/bubble-tea.png",
                name:  "sweet bubble tea"
            },
            {
                img: "assets/images/friends-items/dreamy-cone-three-flavors.png",
        ...
        constellation: "assets/images/constellation/chissuu.png" 
    },
    {
        name: "RedRxven",
        ...
        inventory: [
            {
                img: "assets/images/friends-items/berry-and-mint-burst.png",
                name:  "blueberry smoothie"
            },
            {
                img: "assets/images/friends-items/coffee-bavarois.png",
                name:  "coffe pudding :D"
            },
            {
                img: "assets/images/friends-items/fruits-of-the-festival.png",
                name:  "fresh fruit juice"
            },
            {
                img: "assets/images/friends-items/sparkling-berry-juice.png",
                name:  "sparkling berry juice!"
            },
            {
                img: "assets/images/friends-items/starconch.png",
                name: "starconch"
            }
        ],
        website: "Go check out RedRxven social media!",
        websiteUrl: "https://x.com/Redccoon",
        constellation: "assets/images/constellation/red.png" 
    },
    {
        name: "ne0nbandit",
...
✦ Wants you to ask them about their OCs  `,
        inventory: [
            {
                img: "assets/images/friends-items/hypercube.webp",
                name:  "hypercube"
            },
            {
                img: "assets/images/friends-items/pink-and-blue-gradient.gif",
                name:  "pink and blue gradient (??? how do they have this?)"
            },
            {
                img: "assets/images/friends-items/monster.webp",
                name:  "monster can"
            },
            {
                img: "assets/images/friends-items/spritzee.gif",
                name:  "spritzee"
            }
        ],
        website: "Go check out ne0nbandit site and learn about their art!",
        websiteUrl: "https://ne0nbandit.art/",
        constellation: "assets/images/constellation/ne0nbandit.png" 
    },
    {
        name: "Morita",
        ...
        inventory: [
            {
                img: "assets/images/friends-items/original-resin.png",
            ...
            {
                img: "assets/images/friends-items/polarizing-prism.png",
                name: "prism"
            },
            {
                img: "assets/images/friends-items/super-magnificent-pizza.png",
                name: "huge pizza!"
            }
        ],
        website: "Go check out Morita website!",
        websiteUrl: "https://luvrksnskye.github.io/Douce-Framboise-Cafe-Website/",
        constellation: "assets/images/constellation/morita.png" 
    },
];
    ...
    constructor(isSpecial = false, specialInfo = null, specialIndex = null) {
        ...
        if (isSpecial) {
            ...
            this.icon.src = specialIndex % 2 === 0 ? 
                '/assets/images/icons/ui/friend.png' : 
                '/assets/images/icons/ui/friends.png';
        }
    }
...
const orbitalCircles = [
    new OrbitalCircle('/assets/images/icons/ui/middle.png', 100, 0.002), 
    new OrbitalCircle('/assets/images/icons/ui/center.png', 500, 0.0012, Math.PI / 4), 
    new OrbitalCircle('/assets/images/icons/ui/circle.png', 800, 0.0008, Math.PI / 2), 
    new OrbitalCircle('/assets/images/icons/ui/other-circle.png', 1200, 0.0004, Math.PI),
    new OrbitalCircle('/assets/images/icons/ui/circle-lol.png', 1600, 0.0002, Math.PI * 1.5) 
];
...
function showInfo(info) {
    ...
    const content = `
    <button class="close-button" data-close="info-panel">×</button>
    <h2>${info.name}</h2>

    <div class="star-tabs">
        <button class="star-tab active" data-star-tab="overview">Overview</button>
        <button class="star-tab" data-star-tab="attributes">Attributes</button>
        <button class="star-tab" data-star-tab="inventory">Inventory</button>
        <button class="star-tab" data-star-tab="website">Website</button>
    </div>
...
document.addEventListener('click', (e) => {
    const tab = e.target.closest('[data-star-tab]');
    if (tab) {
        switchStarTab(tab, tab.dataset.starTab);
        return;
    }
    if (e.target.closest('[data-close="info-panel"]')) closeInfoPanel();
});
