document.addEventListener('DOMContentLoaded', () => {
    ...
    const woahSound = new Audio('/assets/audio/sfx/woah.mp3');
    ...
    skyePanel.innerHTML = `
        ...
        <div class="panel-content">
            <div class="header-container" style="display: flex; justify-content: center; align-items: center;">
                <img src="/assets/images/icons/special/arrow-left.png" class="enter-arrow left-arrow" alt="Left Arrow" style="display: none;">
                <h2 style="color: white; text-align: center;">About</h2>
                <img src="/assets/images/icons/special/arrow-right.png" class="enter-arrow right-arrow" alt="Right Arrow" style="display: none;">
            </div>
