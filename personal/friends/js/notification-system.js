function showImageNotification(imagePath) {
  ...
  const audioOpen = new Audio('/assets/audio/sfx/mystical-chime.mp3');
  ...
  const handleClick = () => {
    const audioClose = new Audio('/assets/audio/sfx/selection.mp3');
...
showImageNotification('assets/images/constellation/notice-panel.png');
