...
hcb_user = {
		...
		said:'said:',
		prev_page:'<img src="../../assets/special-icons/arrow-left.png" class="hcb-icon" title="previous page" alt="[prev]"/>',
		next_page:'<img src="../../assets/special-icons/arrow-right.png" class="hcb-icon" title="next page" alt="[next]"/>',
		showing:'Showing',
		to:'to',
