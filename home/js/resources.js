        ...
        class AudioManager {
            constructor() {
                this.sounds = {
                    option: new Audio('../filesystem/resources/assets/audio/sfx/ui-option-click.wav'),
                    confirm: new Audio('../filesystem/resources/assets/audio/sfx/ui-button-confirm.wav'),
                    selectResources: new Audio('../filesystem/resources/assets/audio/sfx/ui-select-resources.wav')
                };
