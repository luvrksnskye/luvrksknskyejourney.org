        ...
        class AudioManager {
            constructor() {
                this.sounds = {
                    option: new Audio('../filesystem/resources/sfx/ui-option-click.wav'),
                    confirm: new Audio('../filesystem/resources/sfx/ui-button-confirm.wav'),
                    selectResources: new Audio('../filesystem/resources/sfx/ui-select-resources.wav')
                };
